...
import 'package:google_sign_in_test/src/helpers/mostrar_alerta.dart';
    ...
    return Row(
      ...
      children: [
        IconButton(
          ...
          onPressed: () async {
            await FaceBookService.signInwithFacebook(context);
          },
        ),
        SizedBox(width: 30),
        IconButton(
          ...
          onPressed: () async {
            await GoogleService.singInWithGoogle(context);
          },
        ),
      ],
    );
