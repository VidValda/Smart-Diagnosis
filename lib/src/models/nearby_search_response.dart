...
//
//     final nearbySearchResponse = nearbySearchResponseFromJson(jsonString);

import 'dart:convert';

NearbySearchResponse nearbySearchResponseFromJson(String str) =>
    NearbySearchResponse.fromJson(json.decode(str));

String nearbySearchResponseToJson(NearbySearchResponse data) =>
