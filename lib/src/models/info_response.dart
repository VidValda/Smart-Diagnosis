...
InfoResponse infoResponseFromJson(String str) => InfoResponse.fromJson(json.decode(str));
...
final shortCodeValues = EnumValues({"us": ShortCode.US, "US-NY": ShortCode.US_NY});

enum Wikidata { Q11299, Q60, Q1384, Q30 }

final wikidataValues = EnumValues(
    {"Q11299": Wikidata.Q11299, "Q1384": Wikidata.Q1384, "Q30": Wikidata.Q30, "Q60": Wikidata.Q60});
